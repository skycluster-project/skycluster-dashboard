        ...
        <ThemeProvider theme={themeDark}>
          ...
          >
            <Box className="flex flex-col grow justify-between">
              <Box className="mx-1">
                <DrawerHeader>
                  <Box className="flex justify-between flex-row py-1">
                    <Link component={RouterLink} to="/" color="#ffffff"
                      underline="none" sx={{ display: "flex", alignItems: "center", gap: 1 }}
                    >
                      <img src={logo} alt="SkyCluster logo"
                        style={{ width: 32, height: 32, objectFit: "contain" }}
                      />
                      <span className="font-extrabold text-4xl font-serif">SkyCluster</span>
                      </Link>
                  </Box>
                </DrawerHeader>
                <Divider/>
